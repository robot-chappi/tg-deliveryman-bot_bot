...
router.post('/checkreview/:id', checkRoleMiddleware(['admin', 'analyst', 'copywriter']), reviewController.checkedUncheckedReview)
...
router.delete('/:id', checkRoleMiddleware(['admin', 'analyst', 'copywriter']), reviewController.deleteReview)
